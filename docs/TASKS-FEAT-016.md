...
- **验证**：Node.js 24.14.1 `./init.sh` 通过 27 files / 317 tests、coverage gate 与 production build；`npm run test:e2e` 三引擎 60/60、tracked-file check passed；用户在当前源码的真实 Electron 窗口确认清空链接与返回顶部均正常。
